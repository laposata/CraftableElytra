...
public class AlternateItemStack{
   ...
   * If both are regular ItemStacks then {@link ItemStack}.isOf(Item) is called instead
  ...
  public static AlternateItemStack getFrom(ItemStack stack) {
    ...
    AlternateItemStack output = new AlternateItemStack(stack.getItem(), alternate, id);
